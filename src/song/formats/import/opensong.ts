...
import {Song, Part, Event, SheetMusic, PartType} from '../../song';
import {SongBuilder} from '../builder';
import {DOMParser} from 'xmldom';

const getXMLTagContent = (doc, tag: string): string => {
...
const processLyricsPiece = (piece) => piece.replace(/_/g, '').replace(/\|/g, ' ').replace(/\s+/g, ' ');
